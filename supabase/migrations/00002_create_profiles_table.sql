-- Profiles table for budget-tracker
...
CREATE TABLE public.profiles (
  ...
  provider_id TEXT,
  settings JSONB DEFAULT '{"theme": "light", "privacy": {"shareStatistics": false}, "language": "ko", "notifications": {"push": false, "email": true}}'::jsonb,
...
COMMENT ON COLUMN public.profiles.settings IS '사용자별 앱 설정 (테마, 언어 등)';
