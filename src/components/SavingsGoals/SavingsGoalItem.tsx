...
const SavingsGoalItem: React.FC<SavingsGoalItemProps> = ({
  ...
  // 금액 계산
  const displayTargetAmount = goal.target_amount;
  const displayCurrentAmount = goal.current_amount;
      ...
      <div className="space-y-2 mb-4">
        <div className="flex items-center justify-between text-sm">
          ...
          <span className="font-semibold text-indigo-600 dark:text-indigo-400">
            ₩{displayCurrentAmount.toLocaleString()}
          </span>
        </div>
        <div className="flex items-center justify-between text-sm">
          <span className="text-gray-600 dark:text-gray-400">목표 금액</span>
          <span className="font-semibold text-gray-900 dark:text-white">
            ₩{displayTargetAmount.toLocaleString()}
          </span>
        </div>
